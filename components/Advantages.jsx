...
export default function Advantages() {
  ...
  const cards = [{
    ...
    descEn: "Engineered with 22mm Natural Eucalyptus and solid natural wood, paired with seamless, sculpted stone countertops and bases.",
    descFa: "ساختاری مهندسی‌شده با استفاده از درهای چوب طبیعی و اکالیپتوس با ضخامت ۲۲ میلی‌متر، در کنار صفحات رویی و پایه‌های مجسمه‌گونه سنگی."
  }, {
    id: "experience",
    num: "II",
    icon: Sparkles,
    ...
    descEn: "Infused with Dorsa Home's signature craftsmanship, highlighted by leather-covered iron cylinder handles and sophisticated leather wall coverings.",
    descFa: "تجلی امضای درسا هوم در جزئیات لوکس، شامل دستگیره‌های استوانه‌ای فلزی با روکش چرم و دیوارپوش‌های چرمی متمایز."
  }, {
    id: "integration",
    num: "III",
    icon: ShieldCheck,
    ...
    descEn: "Fully equipped with professional Gaggenau appliances, seamless Domus lighting, Salice hardware, and Kesseböhmer storage accessories.",
    descFa: "ادغام‌شده با لوازم خانگی توکار لوکس Gaggenau، سیستم‌های نورپردازی حرفه‌ای Domus، یراق‌آلات Salice و اکسسوری‌های ذخیره‌سازی Kesseböhmer."
  }];
  return <section id="advantages" className="relative py-24 md:py-36 bg-[#E8E4DF]/40 dark:bg-[var(--bg-secondary-40)] px-6 sm:px-12 border-b border-[#1C1C1C]/10 dark:border-white/10 overflow-hidden text-left rtl:text-right">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 select-none">
        ...
        <div className="absolute top-0 left-1/3 w-[240px] h-[220%] bg-gradient-to-r from-transparent via-white/[0.04] dark:via-white/[0.14] to-transparent sunbeam-signature-glare pointer-events-none mix-blend-overlay" style={{
        ...
        <div className="max-w-3xl mb-16 md:mb-24">
          ...
          <MaisonReveal variant="unveil" delay={0.2}>
            <h2 className="text-3xl md:text-5xl font-serif font-light tracking-tight leading-tight text-[var(--text-primary)]">
              {isFarsi ? "مزیت رقابتی زاد و تجربه درسا" : "Our Competitive Advantages"}
            </h2>
          </MaisonReveal>
          ...
          <MaisonReveal variant="unveil" delay={0.3}>
            ...
            <p className="text-sm md:text-base text-[var(--text-secondary)] leading-relaxed font-light">
              {isFarsi ? "دقت بی‌رقیب در طراحی جزئیات، کیفیت متریال استثنایی و بهره‌گیری از هنر بی‌بدیل درسا هوم در کنار معتبرترین استانداردهای مهندسی برندهای برتر اروپا." : "The flawless intersection of precision design, engineering milestones, and custom curated European hardware."}
            </p>
          </MaisonReveal>
        </div>
