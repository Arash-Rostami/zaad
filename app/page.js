...
export default function App() {
  ...
  return <div className="min-h-screen flex flex-col justify-between selection:bg-[#EAE7DC] selection:text-[#1C1C1C]">
    ...
    }} selectedProduct={selectedProduct} onSelectProduct={product => setSelectedProduct(product)} onScrollToSection={handleScrollToSection} />

      {/* Main viewport body routing view with fluid exit/entrance choreography */}
      <main className="flex-1">
        <AnimatePresence mode="wait">
          {selectedProduct ? <motion.div key="product-details" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          ease: [0.16, 1, 0.3, 1]
              ...
              <ProductDetailsPage item={selectedProduct} onBack={() => {
            setSelectedProduct(null);
            ...
            </motion.div> : activeTab === "showroom" ? <motion.div key="showroom" initial={{
          opacity: 0
        }} animate={{
          opacity: 1
        }} exit={{
          ...
          duration: 0.6
              ...
              <Showcase onInquireItem={handleInquireItem} onViewDetails={item => setSelectedProduct(item)} />
              ...
              <Concierge preselectedItem={preselectedItem} onClearPreselected={() => setPreselectedItem(null)} />
            </motion.div> : <motion.div key="blueprint" initial={{
          opacity: 0,
          scale: 0.99
        }} animate={{
          opacity: 1,
      ...
      <Footer onScrollToSection={handleScrollToSection} setActiveTab={setActiveTab} />
    </div>;
}
