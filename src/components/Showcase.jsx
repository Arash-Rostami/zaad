    ...
    return (
        ...
        >
            <MaisonReveal variant="unveil" threshold={0.05}>
                <div
                    className="flex flex-col md:flex-row md:items-end justify-between mb-10 pb-6 border-b border-ink/10">
                    <div>
            <span
              ...
              {t("showcaseBadge")}
                ...
                <div
                    className="flex justify-center items-center space-x-6 sm:space-x-10 md:space-x-16 border-b border-ink/10 pb-0 mb-16 mx-auto w-full flex-wrap gap-y-4">
                    {collection.map((item) => {
                        ...
                        return (
                            ...
                            >
                <span
                    className={`text-xs md:text-sm font-serif italic tracking-wider mb-2 transition-all duration-300 ${isActive ? "text-accent font-semibold scale-110" : "text-muted/40 text-headline/30 group-hover:text-accent"}`}
                >
                  {item.number}
                </span>
                                <span
                                    className={`text-base sm:text-lg md:text-xl font-mono tracking-[0.3em] uppercase transition-colors duration-300 ${isActive ? "text-ink font-semibold" : "text-muted/50 dark:text-muted/50 group-hover:text-ink dark:group-hover:text-white"}`}
                                >
            ...
            <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <span>
                    {activeImageIndex + 1} / {selectedItem.images.length}
                                    ...
                                    <span>
                    {selectedItem.images[activeImageIndex]?.orientation === "wide"
                        ? t("showcaseLandscape")
                        : t("showcasePortrait")}
                  </span>
                                </div>
                            ...
                            {viewMode === "macro" && (
                                <div
                                    className="absolute bottom-6 right-6 flex items-center space-x-2 bg-accent border border-accent/20 px-3 py-1.5 rounded-full font-mono text-[8px] tracking-widest text-white z-10 uppercase shadow-card-md select-none">
                        ...
                        {/* View mode toggle */}
                        <div
                            className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-t border-ink/10 pt-4">
              ...
              <span className="text-xs font-mono text-accent font-semibold tracking-widest">
                ...
                <span className="w-1.5 h-1.5 bg-accent rounded-full animate-pulse"/>
                        ...
                        {/* Specifications Folding Dossier */}
                  ...
                  <span
                      className="text-[10px] sm:text-xs font-mono tracking-[0.2em] text-accent font-semibold uppercase">
                    {t("showcaseStudioLookbook")}
                  </span>
                                    <span
                                        className="text-[9px] font-mono text-muted opacity-65 group-hover:opacity-100 transition-opacity">
                    (
                        ...
                        <span
                            className="text-[9px] font-mono text-muted leading-relaxed max-w-sm uppercase text-left rtl:text-right">
                        ...
                        <div
                            className="flex items-center space-x-2 mt-4 text-muted/70 text-[10px] font-mono tracking-wider justify-center sm:justify-start">
                ...
                {selectedItem.name}
                                ...
                                <>
                                    ...
                                    >
                                        <div
                                            ...
                                            <ChevronLeft
                                                className="w-3.5 h-3.5 text-[var(--text-primary)] stroke-[1.2]"/>
                                            <span
                  ...
                  <span className="font-serif text-[15px] italic text-[var(--text-primary)] font-light">
                    {selectedItem.name}
                                    ...
                                    <span className="text-[var(--text-secondary)] opacity-30">•</span>
                                    <span
                                        className="text-[var(--text-secondary)] opacity-80 text-[8.5px] font-mono tracking-[0.2em] uppercase">
