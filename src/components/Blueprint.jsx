              ...
              {t("exploreBriefingFiles")}
                  ...
                  {sec.summary}
                    ...
                    >
                        {active && (
                            <>
                                <div
                                    className="flex items-center justify-between border-b border-ink/10 pb-4 mb-6 text-xs font-mono">
                  <span className="text-accent uppercase tracking-widest font-semibold">
                    ...
                    {t("statusCompliant")}
                                ...
                                <div
                                    className="prose max-w-none text-ink text-sm md:text-base font-light leading-relaxed whitespace-pre-line space-y-6">
                                    {active.content}
                                </div>
