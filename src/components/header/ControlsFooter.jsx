    ...
    return (
        ...
        >
            ...
            <div className="flex items-center space-x-4">
                <div className="flex flex-wrap items-center gap-4 bg-control-bar border border-control px-4 py-2 rounded-full shadow-canvas-mid hover:shadow-canvas-lift transition-all duration-700 ease-[cubic-bezier(0.76,0,0.24,1)]" suppressHydrationWarning>
