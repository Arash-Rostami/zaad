...
const STATIC_BACKGROUND = (
    <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 select-none">
        <div className="absolute left-1/4 top-1/10 w-[700px] h-[700px] rounded-full bg-gradient-to-tr from-accent/0 via-accent/10 to-accent/0 dark:via-accent/20 mix-blend-screen transition-opacity duration-1000" />
                                    ...
                                    <div className="group h-full relative p-8 md:p-10 bg-[var(--bg-card-trans)] border border-[var(--border-color-10)] hover:border-[var(--text-bronze)]/50 transition-all duration-700 rounded-2xl flex flex-col justify-between overflow-hidden">
                                        ...
                                        <div>
                                            <div className="flex justify-between items-center mb-8">
                                                ...
                                                <div className="p-3 bg-[var(--border-color-5)] rounded-xl text-[var(--text-bronze)] group-hover:scale-110 group-hover:bg-accent/10 transition-all duration-500">
