export const COLLECTION_ITEMS = [
  {
    ...
    materials: [
      "MDF Nature Ocaliptus (Eucalyptus) Venner",
    ...
    farsiStory: {
      title: "داستان گوو",
      paragraphs: [
        "زااد به جهان از دریچه ی دقت و ظرافت می‌نگرد؛ جایی که زیبایی به فرم محدود نمی‌شود، بلکه در هماهنگی میان کارایی، جزئیات و دقت جریان می‌یابد.",
        "اصالت، مانند ریشه‌های کهن، ما را همواره به خاستگاه اصلی خود فرامی‌خواند؛ به مکانی که زااد در آن سکنی گزید و گوو «زمین سخاوتمند» گهواره‌ی هستی شد.",
    ...
    partners: {
      typology: "Luxury Kitchen System",
      hardware: "SALICE (Concealed pocket doors & hinges)",
      appliances: "Gaggenau 200/400 cooking series",
      furniture: "DORSA HOME custom bar seating",
      accessories: "Kesseböhmer base storage systems",
      light: "Domus LED micro-profiles",
    },
    islandSpecs: {
      overview:
    ...
    appliancesDetail: [
      {
        ...
        specs: [
          "Width: 90 cm, 5 high-speed induction cooking zones",
          "Intuitive magnetic Twist-Pad control (removable for safety and clean lines)",
          "Flex-zones for merging multiple heating areas to accommodate heavy pots",
        ],
      },
      {
        ...
        specs: [
          "Width: 90 / 120 cm, table-integrated design",
          "Motorized lift: can be lowered flush into the countertop when not in use",
          "High extraction efficiency with low-noise 200 series blower",
        ],
      },
      {
        category: "Ovens",
        ...
        specs: [
          "Width: 60 cm, net volume 76 liters",
          "9 premium heating methods including professional baking stone function",
          "Double-glazed reflective pyrolytic self-cleaning system",
        ],
      },
      {
        category: "Espresso",
      ...
      },
      {
        ...
        name: "Gaggenau Series 200 Vario Refrigerator RC 289",
        specs: [
    ...
    accessoriesDetail: [
      {
        category: "Base Unit Storage",
        name: "Kesseböhmer Dispensa Junior-Arena Storage",
        specs: [
          "Width: 30 to 60 cm, bottom-mounted full extension",
          "Two independent Arena classic non-slip trays adjustable at height",
          "Soft-close damping for fluid, weightless sliding motion",
        ],
      },
      {
        category: "Pull-out Units",
        name: "Kesseböhmer Towel Rail Pull-out (15 cm)",
        specs: [
          "Ultra-slim 15 cm profile utilizing unused architectural gaps",
          "Dual chrome-plated towel bars with full extension runners",
          "Soft-closing mechanism with precise 3D alignment",
        ],
      },
    ],
  },
  {
    ...
    partners: {
      ...
      hardware: "SALICE (Soft-closing heavy hinges)",
      appliances: "Gaggenau 400 Series professional devices",
      furniture: "DORSA HOME curated high stools",
      accessories: "Kesseböhmer smart larder solutions",
      light: "Domus warm ambient lanes",
    },
    islandSpecs: {
      overview:
    ...
    tallUnits: {
      overview:
        "Divided symmetrically into a front-facing appliance wall (Part A) and dry pantry storage cabinetry behind (Part B) to optimize daily service flow and keep clean space.",
      adjacentA: {
      ...
      listSpecs: [
        "Skeletal structure: MDF 18mm melanime-faced panels",
    ...
    appliancesDetail: [
      {
        ...
        specs: [
          "Width: 60 cm, heavy glass-doored luxury profile, volume 76 liters",
          "17 cooking options including core temperature probe and rotisserie spit",
          "Thermally-isolated door with 4-layer glass reflecting heat internally",
        ],
      },
      {
      ...
      {
        category: "Refrigeration",
        name: "Gaggenau Series 400 Vario Refrigerator RC 472",
        specs: [
          "Niche: 76.2 x 213.4 cm, total net volume 479 L",
          "Direct integrated fresh cooling close to 0°C with automated humidity control",
          "No-frost system with beautiful stainless steel inner liner wall",
        ],
      },
      {
        category: "Wine Curation",
        name: "Gaggenau Series 400 Vario Wine Climate Cabinet RW 464",
        specs: [
          "Width: 61 cm, capacity for up to 99 bottles",
          "Two separate, independently controlled climate zones (5°C to 20°C)",
          "UV protection, low vibration compressor, and presentation lighting",
        ],
      },
    ],
    accessoriesDetail: [
      {
        category: "Larder Units",
        name: "Kesseböhmer Tandem Swivel Pull-out Larder",
        specs: [
          "Full extension cabinet split larder system, 50/60 cm widths",
          "Swings open like a refrigerator door, bringing all rear baskets forward",
          "Height-adjustable Arena trays with solid timber and metal frame construction",
        ],
      },
    ],
  },
  {
    ...
    partners: {
      ...
      hardware: "SALICE (Custom pivot screen sliders)",
      appliances: "Gaggenau 200/400 cooking series",
      furniture: "DORSA HOME custom minimal stools",
      accessories: "Kesseböhmer timber interior organization",
      light: "Domus flush-mounted warm profiles",
    },
    islandSpecs: {
      overview:
  ...
  },
  {
    ...
    story:
      "VARR (historically designed as VAAR in ZAAD catalog) is not merely a recipe kitchen; it designs space and establishes absolute, geometric order in the home. Built in 2026, the collection has a majestic look: structural lines are precise and engineered. Slabs ofSicilian volcanic basalt and deep gray travertine are unified onto blackened carbon steel support trusses. Backed by tall units with hand-wrapped leather handles, VARR projects a calm yet steadfast presence that gives structure to beauty.",
    farsiStory: {
      title: "داستان وار",
      paragraphs: [
...
export const BRAND_STORY = {
  philosophy: "Quietude is the highest form of resolution.",
  tagline: "To assemble a space is to curate the silence within it.",
  narrative_1:
    "ZAAD behaves like an architectural filter. In an era structured around visual compression and mass production, we offer the antidote: extreme visual restraint, material physical realness, and timeless permanence. We build spatial experiences that outlast seasons and trends.",
  narrative_2:
